    ...
    <body>
        ...
        <div id="app">
            <div class="contenedorForm">
                <form v-on:submit.prevent="emitirCi">
                    <div>
                        <label for="run">Run: </label>
                        <input type="text" name="run" id="run" v-model="run" />
                    </div>

                    <div>
                        <input type="submit" value="Emitir CI">
                    </div>
                </form>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            numeroDocumento: "123.456.798",
            fechaEmision: "01 ENE 2023",
            fechaVencimiento: "01 ENE 2023",
            firma: "ElOnMusk",
        };
    },
    methods: {
        emitirCi: function () {
            alert(`Cliente con run ${this.run} registrado con éxito.`);
        },
